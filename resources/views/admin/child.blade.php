    ...
    <div class="content-wrapper">
    	<div class="alert alert-success alert-dismissible" role="alert">
    		...
    		<div class="alert-message">
				...
				<a href="{{url('/store-details',$slug)}}" style="color:yellow;" target="_blank">Go to store</a></span>
    	...
    	<div class="container-fluid">
    		...
    		<div class="row mt-3">
				...
				?>
    				...
    				<!-- sdfsdf-->
    				<div class="col-12 col-lg-6 col-xl-2">
    					<a href="{{url('/admin/recived-order-list')}}">
    						<div class="card bg-dark">
    							<div class="card-body">
    								<div class="media">
    									<div class="media-body text-left">
    				...
    				<div class="col-12 col-lg-6 col-xl-2">
    					<a href="{{url('/admin/confirm-order-list')}}">
    						<div class="card bg-dark">
    							<div class="card-body">
    								<div class="media">
    									<div class="media-body text-left">
    				...
    				<div class="col-12 col-lg-6 col-xl-2">
    					<a href="{{url('/admin/shipped-order-list')}}">
    						<div class="card bg-dark">
    							<div class="card-body">
    								<div class="media">
    									<div class="media-body text-left">
    				...
    				<div class="col-12 col-lg-6 col-xl-2">
    					<a href="{{url('/admin/complete-order-list')}}">
    						<div class="card bg-dark">
    							<div class="card-body">
    								<div class="media">
    									<div class="media-body text-left">
    				...
    				<div class="col-12 col-lg-6 col-xl-2">
    					<a href="{{url('/admin/hold-order-list')}}">
    						<div class="card bg-dark">
    							<div class="card-body">
    								<div class="media">
    									<div class="media-body text-left">
    				...
    				<div class="col-12 col-lg-6 col-xl-2">
    					<a href="{{url('/admin/cancel-order-list')}}">
    						<div class="card bg-dark">
    							<div class="card-body">
    								<div class="media">
    									<div class="media-body text-left">
    				...
    				<div class="col-12 col-lg-6 col-xl-2">
    					<a href="{{url('/admin/return-order-list')}}">
    						<div class="card bg-dark">
    							<div class="card-body">
    								<div class="media">
    									<div class="media-body text-left">
