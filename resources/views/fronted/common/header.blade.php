...
<div style="background: white;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="#">
                    <img src="{{url('fronted/img/ads/top-strip-buy.gif')}}" class="img-responsive" style="width: 100%;" />
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="header__content">
        <div class="container">
            <div class="header__content-left">
                        ...
                        <ul class="menu--dropdown">
                            ...
                            foreach ($category as $v) {  ?>
                                <li class="current-menu-item menu-item-has-children has-mega-menu">
                                    <a href="{{url('/shop-list-category/'.$v->slug)}}">{{ $v->category_name }}</a>
                                    <?php
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                    <div class="mega-menu__column col-sm-6">
                                                        <h4><a href="{{url('/shop-list-category/'.$scat->slug)}}" style="font-weight: bold;">{{$scat->sub_cat_name}}<span class="sub-toggle"></span></a></h4>
                                                        <ul class="mega-menu__list">
                                                            ...
                                                            foreach ($insubcat as $s) {  ?>
                                                                <li class="current-menu-item "><a href="{{url('/shop-list-multiple-category/'.$scat->slug.'/'.$s->slug)}}">{{$s->sub_in_sub_cat_name}}</a></li>
                                                            <?php } ?>
                ...
                </div><a class="ps-logo" href="{{ url('/') }}"><img src="{{ url('admin/'.$setting->photo) }}" alt=""> </a>
            </div>
            <div class="header__content-center">
                <form class="ps-form--quick-search" action="{{url('/search-product')}}" method="get">
                    @csrf
                ...
                <div class="header__actions"><a class="header__extra" href="#"><i class="icon-heart"></i><span><i>0</i></span></a>
                            ...
                            <div class="ps-cart__items">
                                ...
                                ?>
                                    ...
                                    <div class="ps-product--cart-mobile">
                                        <div class="ps-product__thumbnail"><a href="#"><img src="{{ $pcode->photo1 }}" alt="" style="height:50px; width: 100%;"></a></div>
                                        <div class="ps-product__content"></a><a href="{{ url('/product-details/'.$pcode->slug) }}">
                                                {{$item->name}}</a>
                                            <p><small> {{$item->quantity}} x {{ $setting->currency }} {{ $pcode->special_price }} = <?php
                                                                                                                                    $item->quantity;
                                                                                                                                    $pcode->special_price;
                    ...
                    <div class="ps-block--user-header">
                        ...
                        <div class="ps-block__right">
                            ...
                            <?php } else { ?>
                                <a href="{{ url('/customer-login-registration') }}">Login</a>
                                <a href="{{ url('/customer-login-registration') }}">Register</a>
                            <?php } ?>
        ...
        <div class="container">
            ...
            <div class="navigation__right">
                ...
                <div class="ps-block--header-hotline inline">
                    <p><a href="{{url('/sell-on-xpesos')}}" class="sell-spesos-link" style="color: black; font-size:15px;">Sell on Xpesos &nbsp;</a></p>|
                    <p><a href="{{url('/track-your-order')}}" class="sell-spesos-link" style="color: black; font-size:15px;">&nbsp; Track Your Order &nbsp;</a></p>
                </div>
            </div>
        </div>
    </nav>
