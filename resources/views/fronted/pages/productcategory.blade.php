        ...
        <div class="container-fluid">
            ...
            <div class="ps-block--categories-box">
                ...
                foreach ($product as $p) {
                    ...
                    <a class="ps-block__overlay" href="{{url('/product/'.$p->slug)}}" target="_self"></a>
                    <img src="{{ url('admin/'.$p->photo1) }}" alt="{{$p->product_name}}" style="border:1px solid #021a40; height: 200px; width: 100%;">
