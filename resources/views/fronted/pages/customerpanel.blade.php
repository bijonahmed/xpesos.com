 ...
 <div class="mapouter">
			...
			<div class="info-contact clearfix">
					...
					<div class="row">
						...
						<address>
							...
							<div class="phone form-group">
								...
								<div class="text">Hot Liner : {{$data->hotline}}</div>
							</div>
				...
				<div class="col-lg-8 col-sm-8 col-xs-12 contact-form">
					<form class="form-horizontal" id="cform" method="post" action="{{url('/savecontactmessages')}}">
						{{ csrf_field() }}
						<fieldset>
							...
							<div class="form-group required">
								<label class="col-sm-2 control-label" for="input-email">Title</label>
								<div class="col-sm-10">
