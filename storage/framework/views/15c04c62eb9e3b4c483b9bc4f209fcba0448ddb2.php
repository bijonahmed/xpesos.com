<header class="header header--mobile" data-sticky="true">
    ...
    <div class="ps-search--mobile navigation--mobile" style=" background-color: white;">
        <a class="ps-logo" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('fronted/img/logo_light.png')); ?>" alt=""></a>
            ...
            <div class="ps-cart__content">
                ...
                ?>
                    <div class="ps-product--cart-mobile">
                        <div class="ps-product__thumbnail"><a href="#"><img src="<?php echo e(url('admin/'.$pcode->photo1)); ?>" alt="" style="height:50px; width: 100%;"></a></div>
                        <div class="ps-product__content"><a class="ps-product__remove" href="#"><i class="icon-cross"></i></a><a href="product-details.php"><?php echo e($item->name); ?></a>
    ...
    <div class="ps-panel__content">
        <ul class="menu--mobile">
            <?php foreach ($category as $v) {  ?>
                <li class="menu-item-has-children has-mega-menu"><a href="<?php echo e(url('/shop-list-category/'.$v->slug)); ?>"><?php echo e($v->category_name); ?></a><span class="sub-toggle"></span>
                    ...
                    ?>
                        ...
                        <div class="mega-menu">
                            ...
                            <div class="mega-menu__column">
                                <h4><?php echo e($v->sub_cat_name); ?><span class="sub-toggle"></span></h4>
                                <ul class="mega-menu__list">
                                    ...
                                    foreach ($insubcat as $s) {  ?>
                                        <li><a href="<?php echo e(url('/shop-list-multiple-category/'.$v->slug.'/'.$s->slug)); ?>"><?php echo e($s->sub_in_sub_cat_name); ?></a>
                                        </li>
                                    <?php } ?>
...
<div class="ps-panel--sidebar" id="menu-mobile">
    ...
    <div class="ps-panel__content">
        <ul class="menu--mobile">
            <?php foreach ($category as $v) {  ?>
                <li class="current-menu-item menu-item-has-children"><a href="<?php echo e(url('/')); ?>"><?php echo e($v->category_name); ?></a><span class="sub-toggle"></span>
                    <ul class="sub-menu">
                        <?php
                        $subcat = DB::table('tbl_subcategory')->where('category_id', $v->category_id)->where('status', 1)->orderBy('category_id', 'desc')->get();
                        $searchsubcat = DB::table('tbl_subcategory')->where('category_id', $v->category_id)->where('status', 1)->orderBy('category_id', 'desc')->get();
                        foreach ($subcat as $v) {
                        ?>
                            <li><a href="<?php echo e(url('/shop-list-category/'.$v->slug)); ?>"><?php echo e($v->sub_cat_name); ?></a>
                            </li>
                        <?php } ?>
...
</div><?php /**PATH E:\xampp\htdocs\xposos_sam_laravel\resources\views/fronted/common/mobile_menu.blade.php ENDPATH**/ ?>