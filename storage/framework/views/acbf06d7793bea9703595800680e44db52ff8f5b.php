...
<script>
	...
	$(document).ready(function() {
		...
		function featch_list(query = '') {
			console.log("bijon");
			$.ajax({
				url: "<?php echo e(route('listBySubCategory.search')); ?>",
				method: 'GET',
				data: {
					query: query
				},
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\xposos_sam_laravel\resources\views/admin/pages/category/subcategorylist.blade.php ENDPATH**/ ?>