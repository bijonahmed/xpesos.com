...
<script>
    ...
    $(document).ready(function() {
        ...
        function featch_category_list(query = '') {
            console.log("bijon");
            $.ajax({
                url: "<?php echo e(route('listByCategory.search')); ?>",
                method: 'GET',
                data: {
                    query: query
                },
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\xposos_sam_laravel\resources\views/admin/pages/category/categorylist.blade.php ENDPATH**/ ?>