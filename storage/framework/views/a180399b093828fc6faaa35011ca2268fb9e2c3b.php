			...
			<div class="ps-product__header ps-product__box">
				<div class="ps-product__thumbnail" data-vertical="true">
					<figure>
						<div class="ps-wrapper">
							<div class="ps-product__gallery" data-arrow="true">
								...
								?>
									<div class="item"><a href="<?php echo e($product->photo1); ?>">
											<img src="<?php echo e($product->photo1); ?>" alt=""></a></div>
								<?php } ?>
					...
					<div class="ps-product__variants" data-item="4" data-md="4" data-sm="4" data-arrow="false">
						...
						if (!empty($product->photo1)) {
						?>
							<div class="item"><img src="<?php echo e($product->photo1); ?>" alt=""></div>
						<?php } ?>
				...
				<div class="ps-product__info">
					...
					<h4 class="ps-product__price"><?php echo e($setting->currency); ?><?php echo e($product->special_price); ?>

						<del><?php echo e($product->regular_price); ?></del></h4>
					...
					<form class="ps-form--newsletter" id="upload_form" method="post" action="<?php echo e(url('/add-to-cart')); ?>">
					...
					<a class="ps-btn" href="<?php echo e(url('checkout')); ?>">Buy Now</a>
				...
				<div class="ps-product__specification"><a class="report" href="#">Report Abuse</a>
					...
					<p class="categories"><strong> Categories:</strong>
						...
						<a href="#"><?php echo e($product->sub_cat_name); ?></a>
						<?php endif; ?>

						<?php if(!empty($product->sub_in_sub_cat_name)): ?>
						<a href="#"><?php echo e($product->sub_in_sub_cat_name); ?></a>
						<?php endif; ?>
							...
							<div class="widget__content">
								...
								?>
									<div class="ps-product">
										<div class="ps-product__thumbnail"><a href="<?php echo e(url ('/product-details/'.$item->slug )); ?>">
												<img src="<?php echo e($item->photo1); ?>" alt="product" style="height: 180px;"></a>
											<div class="ps-product__badge"><?php echo e($product->percentage); ?></div>
										...
										<div class="ps-product__container"><a class="ps-product__vendor" href="#">Robert's Store</a>
											<div class="ps-product__content"><a class="ps-product__title" href="<?php echo e(url ('/product-details/'.$item->slug )); ?>">Grand Slam Indoor Of Show Jumping Novel</a>
												<div class="ps-product__rating">
													<select class="ps-rating" data-read-only="true">
														<option value="1">1</option>
														<option value="1">2</option>
												...
												<p class="ps-product__price sale"><?php echo e($setting->currency); ?><?php echo e($product->special_price); ?> <del><?php echo e($product->regular_price); ?> </del></p>
											</div>
											<div class="ps-product__content hover"><a class="ps-product__title" href="<?php echo e(url ('/product-details/'.$item->slug )); ?>">Grand Slam Indoor Of Show Jumping Novel</a>
												<p class="ps-product__price sale"><?php echo e($setting->currency); ?><?php echo e($product->special_price); ?> <del><?php echo e($product->regular_price); ?> </del></p>
											</div>
										</div>
									</div>
...
<?php echo $__env->make('fronted.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\xposos_sam_laravel\resources\views/fronted/pages/productDetails.blade.php ENDPATH**/ ?>