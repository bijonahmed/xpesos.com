...
<span><strong>Product</strong> List Batech: <?php echo e($filterBatch); ?></span>
<input type="hidden" name="selectbatch" id="selectbatch" value="<?php echo e($filterBatch); ?>"/>

</div>
</div>
<div class="row">
<div class="col-lg-12">
<form enctype="multipart/form-data" method="post" action="<?php echo e(url('admin/updatestatusProducts')); ?>">
...
<table width="100%" border="0">
    ...
    <tr>
        ...
        <td width="25" valign="top">
            <input type="checkbox" name="product_id[]" value="<?php echo e($i->product_id); ?>" />
        </td>
        <td width="189" valign="top"><b>Product ID </b></td>
        <td width="10" valign="top">
            <div align="center">:</div>
        </td>
        <td width="794" valign="top" style="color: blue; font-weight: bold;"> &nbsp;<?php echo e($i->api_id); ?>
    ...
    <tr valign="top">
        ...
        <td width="26%" rowspan="7">
            <?php if(!empty($i->photo1)): ?>
            <img src="<?php echo e(url('admin/'.$i->photo1)); ?>" style="height: 180px; width: 100%; width: 100%; border-radius: 8px;border: 5px solid #555;" class="card-img-top" />
            <?php endif; ?>
        </td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td>&nbsp;<?php echo e($i->regular_price); ?></td>
    </tr>
    ...
    <tr valign="top">
        ...
        <td>&nbsp;<?php echo e($i->stock_quantity); ?></td>
    </tr>
    <tr valign="top" style="background-color: <?php echo e($color); ?>; color: white;">
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>Status </td>
        <td>
...
$.ajax({
    type: 'POST',
    url: "<?php echo e(url('/admin/SaveProduct')); ?>",
    dataType: "json",
    data: {
        _token: _token,
...
function optimizationImage() {
	...
	var _token = $("input[name='_token']").val();
		...
		$("#catloader").show();
		$.ajax({
			url: "<?php echo e(route('getInsertProductImageGallery.search')); ?>",
			data: {
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\xposos_sam_laravel\resources\views/admin/pages/product/productdetailslist.blade.php ENDPATH**/ ?>