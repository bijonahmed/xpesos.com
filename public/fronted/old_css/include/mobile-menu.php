<header class="header header--mobile" data-sticky="true">
        ...
        <div class="ps-search--mobile navigation--mobile">
    ...
    <div class="ps-panel--sidebar" id="navigation-mobile">
        ...
        <div class="ps-panel__content">
            <ul class="menu--mobile">
                <li><a href="shop-list.php">Hot Promotions</a>
                </li>
                <li class="menu-item-has-children has-mega-menu"><a href="shop-list.php">Consumer Electronic</a><span class="sub-toggle"></span>
                    <div class="mega-menu">
                ...
                <li class="menu-item-has-children has-mega-menu"><a href="shop-default.html">Shop</a><span class="sub-toggle"></span>
                    <div class="mega-menu">
                        ...
                        <div class="mega-menu__column">
                            ...
                            <ul class="mega-menu__list">
                                <li><a href="product-details.php">Default</a>
                                </li>
                                ...
                                <li><a href="product-details.php">Fullwidth</a>
                                </li>
                            </ul>
                        </div>
                        <div class="mega-menu__column">
                            ...
                            <ul class="mega-menu__list">
                                <li><a href="product-details.php">Simple</a>
                                </li>
                                <li><a href="product-details.php">Color Swatches</a>
                                </li>
                        ...
                        <div class="mega-menu__column">
                            ...
                            <ul class="mega-menu__list">
                                <li><a href="cart-page.php">Shopping Cart</a>
                                </li>
                                ...
                                <li><a href="login-register.php">My Account</a>
                                </li>
                            </ul>
                        </div>
                    </div>
