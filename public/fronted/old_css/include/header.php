...
<div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="#">
                    <img src="img/ads/top-strip-buy.gif" class="img-responsive" style="width: 100%;"/>    
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="header__top">
            <div class="container">
                <div class="header__left">
                    <p style="font-size:15px;"><a href="sell-on-xpesos.php" class="sell-spesos-link">Sell on Xpesos</a></p>
                </div>
        ...
        <div class="header__content">
            <div class="container">
                ...
                <div class="header__content-center">
                    <form class="ps-form--quick-search" action="http://nouthemes.net/html/martfury/index.php" method="get">
                ...
                <div class="header__content-right">
                    <div class="header__actions"><a class="header__extra" href="wishlist.php"><i class="icon-heart"></i><span><i>0</i></span></a>
                        <div class="ps-cart--mini"><a class="header__extra" href="#"><i class="icon-bag2"></i><span><i>0</i></span></a>
                            <div class="ps-cart__content">
                                <div class="ps-cart__items">
                                    <div class="ps-product--cart-mobile">
                                        <div class="ps-product__thumbnail"><a href="#"><img src="img/products/clothing/7.jpg" alt=""></a></div>
                                        <div class="ps-product__content"><a class="ps-product__remove" href="#"><i class="icon-cross"></i></a><a href="product-details.php">MVMTH Classical Leather Watch In Black</a>
                                            <p><strong>Sold by:</strong> YOUNG SHOP</p><small>1 x $59.99</small>
                                        </div>
                                    </div>
                                    <div class="ps-product--cart-mobile">
                                        <div class="ps-product__thumbnail"><a href="#"><img src="img/products/clothing/5.jpg" alt=""></a></div>
                                        <div class="ps-product__content"><a class="ps-product__remove" href="#"><i class="icon-cross"></i></a><a href="product-details.php">Sleeve Linen Blend Caro Pane Shirt</a>
                                            <p><strong>Sold by:</strong> YOUNG SHOP</p><small>1 x $59.99</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="ps-cart__footer">
                                    ...
                                    <figure><a class="ps-btn" href="cart-page.php">View Cart</a><a class="ps-btn" href="checkout.php">Checkout</a></figure>
                                </div>
                            </div>
                        </div>
                        <div class="ps-block--user-header">
                            <div class="ps-block__left"><i class="icon-user"></i></div>
                            <div class="ps-block__right"><a href="login-register.php">Login</a><a href="login-register.php">Register</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="navigation__left">
                    <div class="menu--product-categories">
                        ...
                        <div class="menu__content">
                            <ul class="menu--dropdown">
                                <li><a href="shop-list.php"><i class="icon-star"></i> Hot Promotions</a>
                                </li>
                                <li class="menu-item-has-children has-mega-menu"><a href="shop-list.php"><i class="icon-laundry"></i> Consumer Electronic</a>
                                    <div class="mega-menu">
                                        <div class="mega-menu__column">
                                            <h4>Electronic<span class="sub-toggle"></span></h4>
                                            <ul class="mega-menu__list">
                                                <li><a href="shop-list.php">Home Audio &amp; Theathers</a>
                                                </li>
                                                <li><a href="#">TV &amp; Videos</a>
                                                </li>
                                                <li><a href="#">Camera, Photos &amp; Videos</a>
